    ...
    <div className="flex flex-col">
      <div className="overflow-x-auto">
        <div className="min-w-full inline-block align-middle">
          <div className="relative flex flex-row justify-between text-gray-500 focus-within:text-gray-900 my-4">
            <div>
              {" "}
            ...
            <div className="flex gap-2 mb-4 mr-4">
              <button
                ...
                className="px-4 py-2 rounded-lg bg-green-600 text-white cursor-pointer duration-300 hover:scale-110 hover:bg-green-800"
              >
                Approved
              </button>
              ...
              <button
                ...
                className="px-4 py-2 rounded-lg bg-orange-600 text-white cursor-pointer duration-300 hover:scale-110 hover:bg-orange-800"
              >
                Pending
              </button>
              ...
              <button
                ...
                className="px-4 py-2 rounded-lg bg-red-600 text-white cursor-pointer duration-300 hover:scale-110 hover:bg-red-800"
              >
                Rejected
              </button>
            </div>
          ...
          <div className="overflow-hidden">
            <table className="min-w-full rounded-xl">
              ...
              <tbody className="divide-y divide-gray-300">
                {[...signatures]
                  .filter((sig) => sig.status === filterStatus)
                  .reverse()
                  .map((signature) => (
                    <tr
                      key={signature.id}
